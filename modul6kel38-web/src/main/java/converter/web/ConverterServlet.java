...
// Output the results
 ...
 try { String degree = request.getParameter("degree");
 if ((degree != null) && (degree.length() > 0)) { double d = Double.parseDouble(degree);
...
if (request.getParameter("K TO R") != null) { 
 ...
 out.println("<br/>");
 out.println("<input type=\"submit\" name=\"R TO K\" value=\"R TO K\">" + "<input type=\"submit\" name=\"K TO R\" value=\"K TO R\">");
 out.println("</form>");
 }
 } finally {
 out.println("</body>");
